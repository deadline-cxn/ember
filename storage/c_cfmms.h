...
typedef enum
{
    MS_CTRL_NOTCONNECT,     // not connected to any host
    MS_CTRL_LOGGINPROC,     // connected but not logged in
    MS_CTRL_SYSBUSY,        // if some class internal things (filetransfer) are done
    MS_CTRL_CONNECTED,      // ok normal connecting
} eFMMSConnectionState;
