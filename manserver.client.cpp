...
void C_GSC::load(void){
    ...
    tv=explode(",",db_getvalue("username",username,"chat_channels").c_str());
    for(i=0;i<tv.size();i++){
...
void C_GSC::do_net(void){
    ...
    if(iMsg>0){
        ...
        switch(cMsgType)
        {
            ...
            case NM_LOGIN_REQUEST: fold_block {
                ...
                if(dbr_nrow==0){
                    ...
                    if(ax==BAD_LOGIN){
                        if((dscc(szTemp4,db_getvalue("username",username,"password").c_str() )))
                            ax=GOOD_LOGIN;
                    }
                }
            ...
            case NM_GUI_CALLBACK: fold_block {
            ...
            case NM_MESSAGE:  fold_block { // Global Chat / System Message
            ...
            case NM_MOVEPLAYER: fold_block {

                break; }

            case NM_CREATE_CHARACTER: fold_block {
                /* inactivity_timer->Reset();
            ...
            case NM_DELETE_CHARACTER: fold_block {
                inactivity_timer->Reset();
                cx = Recv->cRead();
            ...
            case NM_RETRIEVECHARS: fold_block {
            ...
            case NM_RETRIEVECHARINFO: fold_block {
            ...
            case NM_MODIFY_CHARACTER: fold_block {
                inactivity_timer->Reset();
            ...
            case NM_CLIENT_SHUTDOWN: fold_block {
